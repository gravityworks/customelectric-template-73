...
const OurVision = () => {
  ...
  return <section className="py-20 bg-brand-blue">
      <div className="container mx-auto px-4 max-w-6xl text-center">
        <h2 className="text-4xl font-display text-white mb-4">Our Mission</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-5xl mx-auto">
          {values.map((value, index) => <div key={index} className="flex flex-col items-center text-center space-y-4">
